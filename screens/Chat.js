...
const messages = [{from: {name: 'Warda', image: require('./img/me.png')}, message: 'Come va?', read: false, date: new Date()},
                  {from: {name: 'Store Manager 1', image: require('./img/me.png')}, message: 'Ciao...', read: true, date: new Date()},
                  {from: {name: 'Store Manager 2', image: require('./img/me.png')}, message: 'Ora faccio il task', read: false, date: new Date()},
